...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="index.jsp" class="tip-bottom">Contact Management</a> <a href="#" class="current">View Contact</a> </div>
  <h1>View Contacts</h1>
</div>
...
String sql ="select * from contactmanagement where user = '" + userName +"'";
...
<td><%=resultSet.getString("assignTo") %></td>
