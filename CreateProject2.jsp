...
<html lang="en">
    ...
    <link rel="stylesheet" href="css/datepicker.css" />
        ...
        <link rel="stylesheet" href="https://assets/lib/inputlimiter/jquery.inputlimiter.css">
       
        <link rel="stylesheet" href="https://assets/lib/bootstrap-daterangepicker/daterangepicker-bs3.css">
...
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <body>
        ...
        <div class="bg-dark dk" id="wrap">
            ...
            <form class="form-horizontal" method="POST" action="ProjectServlet2.do">
              ...
              <div class="col-lg-8">
                  <input type="text"  name="projectName" required class="form-control" id="text1" placeholder="" /> 
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                  <textarea class="form-control" required id="autosize" name="projectDescription" ></textarea>
              </div>
            </div>
              ...
              <div class="col-lg-8">
                  <input type="text" name="clientName" required class="form-control" id="text1"  placeholder="" /> 
              </div>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="input-group input-append  date" id="dpYears" data-date="12-02-2012"
                                ...
                                <input class="datepicker form-control" type="date"  name="startDate">
              ...
              <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Assign User :</label> 
              <div class="col-lg-8">
...
%>
            ...
            <select class="form-control chzn-select" name="employees">
