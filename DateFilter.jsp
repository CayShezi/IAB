...
<![endif]-->
    ...
    <script scr="https://code.jquery.com/jquery-2.1.3.js"></script>
...
$(document).ready(function(){
  ...
  <!---For Open and Closing Of the Open and Close the div ------>
  <script
							...
							<tr>
								<td>
									<li id="one">
													...
													<a class="quick-btn open" href="#">
	<i class="fa fa-check fa-2x"></i>
	
	<span class="label label-default"><%=resultSet.getString("p.projectName")%></span>
    </a>
			...
			<script>
				...
				open.click(function(e){
					...
					if($this.hasClass('active') === true) {
						$this.removeClass('active').next('.box2').slideUp(speed);
					} else if(a.hasClass('active') === false) {
						$this.addClass('active').next('.box2').slideDown(speed);
					} else {
						a.removeClass('active').next('.box2').slideUp(speed);
						$this.addClass('active').next('.box2').delay(speed).slideDown(speed);
					}
				});
