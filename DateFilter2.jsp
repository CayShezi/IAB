...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <nav class="cmn-tile-nav">
        ...
        <li class="colour-3" style="width:200px"><a href="#">Top Leads</a></li> 
      </ul>
    </nav>
...
String sql = "select * from recordv1 where score IS NOT NULL ORDER BY dateEnding ASC";
...
%>
       ...
       <div class="form-actions">
                    ...
                    <span class="pull-right"><a href="PreviewLeads2.jsp" class="btn btn-info"/>Preview</a></span>
                </div>
    </div>
</div>
