...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <nav class="cmn-tile-nav">
        ...
        <li class="colour-1" style="width:200px"><a href="SourceFilter2.jsp">Sources</a></li>
        <li class="colour-2" style="width:200px"><a href="DateFilter2.jsp">Closing Date</a></li>
        <li class="colour-3" style="width:200px"><a href="TopLeads.jsp">Top Leads</a></li> 
      </ul>
    </nav>
...
String sql ="select * from recordv1 where score IS NOT NULL ORDER BY sourceName ASC";
...
%>
       ...
       <div class="form-actions">
                    <span class="pull-left"><a href="Report2.jsp" class="flip-link btn btn-success" id="to-login">&laquo; Back to report </a></span>
                    <span class="pull-right"><a href="PreviewLeads.jsp" class="btn btn-info"/>Preview</a></span>
                </div>
    </div>
</div>
