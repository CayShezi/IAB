...
<td><%=resultSet.getString("employeeSurname") %></td>
<td><%=resultSet.getString("address") %></td>
<td><%=resultSet.getString("email") %></td>
<td><%=resultSet.getString("telephoneNo") %></td>
<td>

    <%
    
        String fdfdfdf = resultSet.getString("reportTo");
    %>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql2 ="select * from employees where reportTo = '" + fdfdfdf + "'";
