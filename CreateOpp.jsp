...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Opportunity Management</a> <a href="CreateOpp.jsp" class="current">Create Opportunity</a> </div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="CreateOppServlet.do">
            <div class="control-group">
              <label class="control-label">Opportunity Name :</label> 
              <div class="controls">
                  <input type="text" class="span4" name="oppName" placeholder="" /> 
              </div>
...
%>
            ...
            <div class="control-group">
              <label class="control-label">Opportunity Amount :</label>
              <div class="controls">
                <input type="text" class="span4" name="oppAmount" placeholder="" />
              </div>
            </div>
...
%>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="dueDate" data-date="01-02-2013" data-date-format="yyyy-mm-dd" value="2013-04-23" class="datepicker span4">
