...
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <body>
        ...
        <div class="bg-dark dk" id="wrap">
            ...
            <form class="form-horizontal" method="POST" action="ProjectServlet.do">
...
String sql ="select * from opportunity o , employees e where i_d = '" + id + "' AND e.employeeID = o.employees";
...
%>
              ...
              <div class="col-lg-8">
                  <input type="text" name="projectName" class="form-control" id="text1" required value="<%=resultSet.getString("oppName")%>" placeholder="" /> 
              </div>

            </div>
              
            <div class="form-group">
              <label for="autosize" class="control-label col-lg-4">Project Description </label>
              <div class="col-lg-8">
                   <textarea class="form-control" required id="text1" name="projectDescription"><%=resultSet.getString("description")%></textarea>
              </div>
            </div>
              ...
              <div class="col-lg-8">
                  <input type="text" name="clientName" required class="form-control" id="text1" value="<%=resultSet.getString("clientName")%>" placeholder="" /> 
              </div>
              </div>
              ...
              <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Assigned User </label> 
              <div class="col-lg-8">
              <input type="text" class="form-control" id="text1" value="<%=resultSet.getString("employeeName")%>" placeholder="" /> 
              <input type="hidden" name="employee" class="span4" value="<%=resultSet.getString("employees")%>" placeholder="" /> 
              </div>
            


           <input type="hidden" name="briefingSessionDate" class="span4" value="<%=resultSet.getString("briefingSessionDate")%>" placeholder="" /> 
           <input type="hidden" name="sourceName" class="span4" value="<%=resultSet.getString("sourceName")%>" placeholder="" /> 
           <input type="hidden" name="oppID" class="span4" value="<%=resultSet.getString("i_d")%>" placeholder="" /> 
