...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <nav class="cmn-tile-nav">
        ...
        <li class="colour-3" style="width:200px"><a href="FilterBySourceServlet3.do?action=sourceName3"><%=sourceName3%></a></li> 
      </ul>
    </nav>
  ...
  <div class="tbl-header">
      ...
      <c:set var = "empId" scope="session" value = "${f}"/>
      ...
      <table border = "1" width = "100">
       ...
       <div class="form-actions">
                    <span class="pull-left"><a href="SearchServlet.do?action=ListAllData" class="flip-link btn btn-success" id="to-login">&laquo; Back to report </a></span>
                    <span class="pull-right"><a href="demos/selectable.jsp" class="btn btn-info"/>Proceed</a></span>
                </div>
    </div>
</div>
