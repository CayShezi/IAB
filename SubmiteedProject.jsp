...
<![endif]-->
  ...
  <div class="outer">
      ...
      <ul style="float:right">
          <a href="#"  title="Grid View"><i class="glyphicon glyphicon-th-list" style="font-size: 20px;color: #ffffff"></i></a>&nbsp;
        <a href="SubmittedProjectCardView.jsp" title="Card View"><i class="glyphicon glyphicon-th" style="font-size: 20px;color: #ffffff"></i></a>
     </ul>
  ...
  <div class="col-lg-12">
        <div class="box">
			 ...
			 <li><a href="currentProject.jsp">Current Projects</a></li>
                         <li class="active"><a href="SubmiteedProject.jsp">Submitted Projects</a></li>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select * from projectmanagement p, employees e where status = '" + "submitted" +"' AND p.projectManager = e.employeeID";
resultSet = statement.executeQuery(sql);
