   ...
   <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
            ...
            <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Opportunity Management</span> <span class="label label-important"></span></a>
             ...
             <li><a href="SalesOpportunity.jsp"><i class="icon icon-home"></i><span>View Opportunities</span></a></li>
               ...
               <li class="submenu  active"> <a href="#"><i class="icon icon-th-list"></i> <span>Account Management</span> <span class="label label-important"></span></a>
        ...
        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Account Management</a> <a href="#" class="current">Create Account Report</a> </div>
            </div>
            <div class="container-fluid">
                                       <nav class="cmn-tile-nav">
      <ul class="clearfix" style="padding-left:4.9cm;">
        <li class="colour-1" style="width:200px"><a href="AccountNoFilter.jsp">Accounts</a></li>
        <li class="colour-2" style="width:200px"><a href="#">Revenue Contribution</a></li>
