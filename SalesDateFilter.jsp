...
<html lang="en">
   ...
   <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
            ...
            <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Opportunity Management</span> <span class="label label-important"></span></a>
               ...
               <li class="submenu active"> <a href="#"><i class="icon icon-th-list"></i> <span>Sales Management</span> <span class="label label-important"></span></a>
...
<div class="container-fluid">
      ...
      <ul class="clearfix" style="padding-left:2.9cm;">
        ...
        <li class="colour-2" style="width:200px"><a href="#">Successful vs Unsuccessful</a></li>
        <li class="colour-3" style="width:200px"><a href="#">Pending Responses</a></li>
        <li class="colour-4" style="width:200px"><a href="#">Potential vs Cost</a></li>
      </ul>
    </nav>
  <hr>
  <div class="row-fluid">
...
String sql ="select * from opportunity where status = '" + "submitted" + "'";
