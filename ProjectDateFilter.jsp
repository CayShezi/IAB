...
<html lang="en">
   ...
   <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
            ...
            <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Opportunity Management</span> <span class="label label-important"></span></a>
               ...
               <li class="submenu  active"> <a href="#"><i class="icon icon-th-list"></i> <span>Project Management</span> <span class="label label-important"></span></a>
                ...
                <li> <a href="ViewProjectTask.jsp"><i class="icon icon-table"></i> <span>View Project Tasks</span></a></li>
                 <li><a href="ProjectDateFilter.jsp"><i class="icon icon-table"></i> <span>Create Report</span></a></li>
...
<div class="container-fluid">
      ...
      <ul class="clearfix" style="padding-left:4.9cm;">
        ...
        <li class="colour-3" style="width:200px"><a href="#">Submitted</a></li>
        <li class="colour-4" style="width:200px"><a href="#">Deferred</a></li>
      </ul>
    </nav>
  <hr>
  <div class="row-fluid">
