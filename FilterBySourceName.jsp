    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Opportunity Management</span> <span class="label label-important"></span></a>
        ...
        <div id="content">
            ...
            <%
                ...
                List<SourceData> sourceData = (ArrayList<SourceData>)session.getAttribute("report");
            ...
            <div class="container-fluid">
                ...
                <nav class="cmn-tile-nav">
                    <ul class="clearfix" style="padding-left:6cm;">
                        <li class="colour-1" style="width:200px"><a href="FilterBySourceName.jsp"><%=souceName%></a></li>
                        ...
                        <div class="widget-box">
                            <section>
                                ...
                                <div class="tbl-header">
                                    ...
                                    <form action="SortServlet.do" method="POST">
