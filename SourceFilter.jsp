...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <nav class="cmn-tile-nav">
        ...
        <li class="colour-1" style="width:200px"><a href="SourceFilter.jsp">Sources</a></li>
        <li class="colour-2" style="width:200px"><a href="DateFilter.jsp">Closing Date</a></li>
...
String sql ="select * from record where score IS NOT NULL ORDER BY sourceName ASC";
