...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
			 ...
			 <li  class="active"><a href="SalesOpportunity.jsp">Current Sales</a></li>
                <li><a href="#">Pending</a></li>
                <li><a href="SalesArchive.jsp">Sales Archive</a></li>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql = "select * from salesmanagement";
resultSet = statement.executeQuery(sql);
...
<td><%=resultSet.getString("dateSubmitted") %></td>
<td>View Documents</td>
<td><%=resultSet.getString("validityPeriod") %></td>


<td><input type="text" name="comment" value="" /></td>
<td><a class="tip <%=salesUpdateLink%>" href="SalesEdit.jsp?id=<%=resultSet.getString("salesID")%>" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a> <a class="tip <%=salesDeleteLink%>" href="DeleteSales.jsp?id=<%=resultSet.getString("salesID")%>" title="Delete"><i class="glyphicon glyphicon-remove"></i></a> <a class="tip <%=accountCreateLink%>" href="CreateContract.jsp?id=<%=resultSet.getString("salesID")%>" id="createAccount" title="Add"><i class="glyphicon glyphicon-plus"></i></a></td>
</tr>
<%
i++;
}
       ...
       <script src="assets/lib/jquery/jquery.js"></script>
        ...
        $(function () {
            $("#createAccount").click(function () {
                var submitted = $("#Submit").val();
               
                if (submitted != "Approved") {
                    alert("Sale has not been approved yet");
                    return false;
                }
                return true;
            });
