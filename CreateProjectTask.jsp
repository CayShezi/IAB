    ...
    <body>
        ...
        <div class="bg-dark dk" id="wrap">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input type="text" name="taskName" required class="form-control" id="text1" placeholder="" /> 
              </div>
...
%>
             ...
             <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Upload Document :</label>
              <div class="col-lg-8">
              <a href="UploadDocumentationTask.jsp?id=<%=id%>"><button type="button" class="btn btn-primary">Upload</button></a>
          </div>
