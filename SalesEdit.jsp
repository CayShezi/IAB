...
<div class="bg-dark dk" id="wrap">
        ...
        <!--close-left-menu-stats-sidebar-->
            ...
            <form method="POST" class="form-horizontal" action="UpdateSales.jsp">
...
%>
              ...
              <tbody>
                <tr class="gradeX">
                        ...
                        <input type="hidden" name="id" value="<%=resultSet.getString("salesID")%>">
                    ...
                    <div class="col-lg-8">
                        <input type="text" name="clientName" class="form-control"  value="<%=resultSet.getString("clientName")%>">
                        </div>
                    </div>
                   ...
                   <div class="col-lg-8">
                        <input type="text" name="type" class="form-control"  value="<%=resultSet.getString("type")%>">
                        </div>
                    </div> 
              ...
              <div class="form-group">
                   ...
                   <div class="col-lg-8">
                       <textarea class="form-control"  name="description"><%=resultSet.getString("description")%></textarea>
                        </div>
                    </div>
                        
                        
                 <div class="form-group">
                     <label for="text1" class="control-label col-lg-4">Sales Number </label>
                   <div class="col-lg-8">
                        <input type="text" class="form-control" name="salesNumber" value="<%=resultSet.getString("salesNumber")%>">
                        </div>
                    </div>
                   ...
                   <div class="col-lg-8">
                        <input type="text" class="form-control" name="status" value="<%=resultSet.getString("status")%>">
                        </div>
                    </div>
