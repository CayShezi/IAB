...
<%
        String id = (String)session.getAttribute("certficateID");
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String st="insert into certificatedoc(filename,type,content,upload_by) values (?,?,?,?)";
            ...
            RequestDispatcher disp = request.getRequestDispatcher("RegistrationForm.jsp");
