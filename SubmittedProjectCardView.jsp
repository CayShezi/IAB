...
String sql ="select * from projectmanagement p, employees e where status = '" + "Submitted" + "' AND e.employeeID = p.projectManager";
										...
										<div class="profile">
											<h4 class="resize"><b>
											 ...
											 <%
                                                                                              ...
                                                                                              String des =   resultSet.getString("projectDescription");
                                                                                              
                                                                                        
                                                                                        %>
                                                                                        
                                                                                        
                                                                                        <c:set var="msg" value="<%=des%>"/>

											<p  class="description resize2">${fn:substring(msg, 0, 12)}...</p>
