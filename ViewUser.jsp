...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="" class="tip-bottom">Employee</a> <a href="#" class="current">View Employees</a> </div>
  <h1>View Users</h1>
</div>
