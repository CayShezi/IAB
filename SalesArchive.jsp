...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
			 ...
			 <li><a href="SalesOpportunity.jsp">Current Sales</a></li>
                <li><a href="#">Pending</a></li>
                <li class="active"><a href="SalesArchive.jsp">Sales Archive</a></li>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql = "select * from salesarchive";
resultSet = statement.executeQuery(sql);
...
<td><a class="tip" href="SalesRestoreServlet.do?projectID=<%=resultSet.getString("projectID")%>" title="Restore Sales"><i class="glyphicon glyphicon-repeat"></i></a></td>
</tr>
<%
i++;
}
