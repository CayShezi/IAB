...
<div class="row">
  <div class="col-lg-12">
        <div class="box">
			...
			<li class="active">
        <a href="#1a" data-toggle="tab">Current Opportunities</a>
			</li>
			<li><a href="#2a" data-toggle="tab">Pending</a>
			</li>
			<li><a href="OppArchive.jsp" >Opportunity Archive</a></li>
...
%>
<td><a class="tip <%=oppUpdateLink%>" href="OpportunityEdit.jsp?id=<%=resultSet.getString("i_d")%>" title="Edit Opportunity"><i class="glyphicon glyphicon-pencil"></i></a> <a class="tip <%=oppDeleteLink%>" href="OppArchieveServlet.do?id=<%=resultSet.getString("i_d")%>" title="Delete"><i class="glyphicon glyphicon-remove"></i></a> <a class="tip <%=projectCreateLink%>" href="CreateProject.jsp?id=<%=resultSet.getString("i_d")%>" title="Add"><i class="glyphicon glyphicon-plus"></i></a></td>
</tr>
