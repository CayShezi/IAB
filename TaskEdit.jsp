   ...
   <!--sidebar-menu-->
        ...
        <div class="bg-dark dk" id="wrap">
           ...
           <div class="toolbar">
            ...
            <form method="POST" class="form-horizontal" action="UpdateTask.jsp">
...
String sql ="select * from projecttask t, projectmanagement p where t.task_ID = '" + id + "' AND t.projectName = p.projectID";
...
%>
              ...
              <tbody>
                <tr class="gradeX">
                     ...
                     <label for="text1" class="control-label col-lg-4">Task Name </label>
                    <div class="col-lg-8">
                        <input type="text" class="form-control"  name="taskName" value="<%=resultSet.getString("taskName")%>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" value="<%=resultSet.getString("p.projectName")%>">
                         <input type="hidden" class="form-control" name="projectID" value="<%=resultSet.getString("t.projectName")%>">
                        </div>
                    </div>
                        
                        
                                      <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Assign To </label>
              <div class="col-lg-8">
                                            <%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
...
%>
                        ...
                        <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Priority :</label>
              <div class="col-lg-8">
                  <select class="form-control chzn-select" name="priority">
                  <option>High</option>
