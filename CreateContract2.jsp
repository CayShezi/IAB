...
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <body>
        ...
        <div class="bg-dark dk" id="wrap">
            ...
            <form class="form-horizontal" method="POST" action="ContractServlet2.do">
                
                
                
                  <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Contract Name </label> 
              <div class="col-lg-8">
                <input type="text" name="contractName"  placeholder="" class="form-control" id="text1"> 
              </div>
                 ...
                 <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Contract Duration </label> 
              <div class="col-lg-8">
                <input type="text" name="contractDuration" placeholder="" class="form-control" id="text1"> 
              </div>
              ...
              <div class="form-group">
              <label  for="text1" class="control-label col-lg-4">Contract Description </label>
              <div class="col-lg-8">
               <textarea id="autosize" class="form-control" name="contractDescription"></textarea>
              </div>
            </div>
          
              
                           <div class="form-group">
              <label class="control-label col-lg-4">Contract Manager </label>
              <div class="col-lg-8">
                                            <%
try{
...
%>
          ...
          <div class="form-group">
               ...
               <div class="input-group input-append  date" id="dpYears" data-date="12-02-2012"
                                 data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                <input class="form-control datepicker" type="date" value="12-02-2012" name="endDate">
                                <span class="input-group-addon add-on"><i class="fa fa-calendar"></i></span>
                            </div>
            </div>
                    ...
                    <div class="form-group">
              <label for="text1" class="control-label col-lg-4">Contract Contact </label> 
              <div class="col-lg-8">
                <input type="text" name="contact" placeholder="" id="text1" class="form-control"> 
              </div>
