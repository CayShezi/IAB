...
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <body>
        ...
        <div class="bg-dark dk" id="wrap">
            ...
            <form class="form-horizontal" method="POST" action="ContractServlet.do">
...
String sql ="select * from salesmanagement where salesID = '" + id + "'";
resultSet = statement.executeQuery(sql);
%>
 
            <select class="form-control" name="sales">
        <%  while(resultSet.next()){ %>
            <option value = "<%=resultSet.getString("clientName")%>"><%=resultSet.getString("clientName")%></option>
        <% } %>
        </select>
