...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Project Management</a> <a href="#" class="current">Deferred Project</a> </div>
</div>
<div class="container-fluid">
    
                   <nav class="cmn-tile-nav">
      <ul class="clearfix" style="padding-left:6cm;">
        <li class="colour-1" style="width:160px"><a href="OppDateFilter.jsp">Date Range</a></li>
...
String sql ="select * from opportunity where status = '" + "Deferred" + "'";
