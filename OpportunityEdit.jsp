...
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
   ...
   <!--sidebar-menu-->
        ...
        <div class="bg-dark dk" id="wrap">
            ...
            <form method="POST" class="form-horizontal" action="UpdateOpp.jsp">
...
String sql ="select * from opportunity where i_d = '" + id + "'";
              ...
              <tbody>
                <tr class="gradeX">
                    ...
                    <div class="form-group">
                     <label for="text1" class="control-label col-lg-4">Opportunity Name </label>
                    <div class="col-lg-8">
                        <input type="text" name="oppName" class="form-control"  value="<%=resultSet.getString("oppName")%>">
                        </div>
                    </div>
              ...
              <div class="form-group">
                    ...
                    <div class="col-lg-8">
                       <textarea class="form-control"  name="description"><%=resultSet.getString("description")%></textarea>
                         ...
                         <div class="form-group">
                     <label for="text1" class="control-label col-lg-4">Due Ending </label>
                    <div class="col-lg-8">
                        <input type="text" class="form-control"  name="dateEnding" value="<%=resultSet.getString("dateEnding")%>">
                        </div>
                    </div>
