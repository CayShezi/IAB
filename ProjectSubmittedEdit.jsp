...
<div class="bg-dark dk" id="wrap">
        ...
        <!--close-left-menu-stats-sidebar-->
            ...
            <form method="POST" class="form-horizontal" action="UpdatePSS.jsp">
...
%>
              ...
              <tbody>
                <tr class="gradeX">
                        ...
                        <input type="hidden" name="oppID" value="<%=resultSet.getString("oppID")%>">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="projectName" value="<%=resultSet.getString("projectName")%>">
                        </div>
                    </div>
