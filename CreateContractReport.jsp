 ...
 <link rel="stylesheet" href="style/style.css">
    ...
    <body>
      ...
      <ul class="dropdown-menu">
        ...
        <jsp:include page="AccountInclude.jsp.jsp"></jsp:include>

        <!--close-left-menu-stats-sidebar-->

        <div id="content">
            <div id="content-header">
                <div id="breadcrumb"> <a href="index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Contract Management</a> <a href="#" class="current">Create Contract Report</a> </div>
            </div>
      ...
      <ul class="clearfix" style="padding-left:4.9cm;">
        ...
        <li class="colour-2" style="width:200px"><a href="ContractDurationFilter.jsp">Contract Duration</a></li>
